"""
SQLAlchemy database models for the admin interface.

This module defines the ORM models for recognizers, patterns, context words,
and admin users stored in the SQLite database.
"""
